...
//
// public class StockMetadataExcelLoader : StockMetadataLoader
// {
...
//             row =>
//                 new StockMetadata(
//                     CFG.ShangHaiPrefix + row.GetCell(0).StringCellValue,
...
//             row =>
//                 new StockMetadata(
//                     CFG.ShenZhenPrefix + row.GetCell(4).StringCellValue,
//                     row.GetCell(5).StringCellValue
//                 )
//         );
//     }
//
//     private static IEnumerable<StockMetadata> LoadFromExcel(
//         string file,
//         Func<IRow, StockMetadata> extractor
//     )
//     {
